...
<nav>
    ...
    <a href='liquorcabinet.php'>Liquor Cabinet</a> |
    <a href='customrecipes.php'>Custom Recipes</a> |
...
<div>
    ...
    <div>
        <h3>Enter the liquor that you own</h3>
	</div>
...
if(isset($_COOKIE["Session"])){
    ...
    {
        echo "<h3>".$cookieArray['username'] . "'s Liquor Cabinet</h3>";
    }
}else{
